...
@implementation PortraitPageControl
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        normalImage = [UIImage imageNamed:@"pagecontrol_normal.png"];
    }
...
- (id)initWithReuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) 
    {
        ...
        //
        pageView = [[PortraitPageControl alloc] initWithFrame:CGRectZero];
...
-(void)setImages:(NSArray *)value
{
    ...
    [pageView setHidden:!([images count] > 1)];
}

...
#define kTextureMaxWidth	1500
#define kTextureMaxHeight	1500
...
#define kDefaultPitchMinRange -10.0f
#define kDefaultPitchMaxRange 10.0f
...
#define kDefaultInertiaInterval 0.5

...
{
	return [[[PLTexture alloc] initWithPath:path] autorelease];
}

+ (id)textureWithPathAndRelease:(NSString *)path
{
	return [[[PLTexture alloc] initWithPathAndRelease:path] autorelease];
}

+ (id)textureWithImage:(UIImage *)image rotate:(int)angle
{
	return [[[PLTexture alloc] initWithImage:image rotate:angle] autorelease];
}

+ (id)textureWithPath:(NSString *)path rotate:(int)angle;
{
	return [[[PLTexture alloc] initWithPath:path rotate:angle] autorelease];
}

+ (id)textureWithPathAndRelease:(NSString *)path rotate:(int)angle
{
	return [[[PLTexture alloc] initWithPathAndRelease:path rotate:angle] autorelease];
}
